...
<body>
  ...
  <h1 class="mt-3">👑BLACK PANTHER RULEX 💀👑<a
  </header>
  ...
  <footer class="footer">
    ...
    <p><a href="https://www.facebook.com/blackpantherrulexkaownerkamena">ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ ғᴀᴄᴀʙᴏᴏᴋ</a></p>
    <div class="mb-3">
      <a href="https://www.instagram.com/kameena_hu_yrr?igsh=d2pwZHE3aHN1MWsw" class="instagram-link">
        <i class="fab fa-instagram"></i> ᴄʟɪᴄᴋ ʜᴇʀᴇ ғᴏʀ instagram</a>
    </div>
  </footer>
</body>
</html>
